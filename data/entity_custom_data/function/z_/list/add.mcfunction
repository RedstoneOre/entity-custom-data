...
execute if score delete.cur.end.low entity_custom_data.data matches 2147483639.. run scoreboard players set delete.cur.end.low entity_custom_data.data 0
