...
execute if score delete.cur.end.low entity_custom_data.data matches -1 run scoreboard players set delete.cur.end.low entity_custom_data.data 2147483647
#delete
